<?
$module_name = "personnel type";
$module_data = "personnel-type";
$table = "personnel_type";
...
$query_search = $filter_search != "" ? ' AND (
	t1.type_name LIKE "%'.$filter_search.'%" 
) ' : ' ';
		...
		<td align="right" class="px_10" valign="top">
			...
			<div class="float_right px_10" style="width:50%;">
			    ...
			    <select id="filter_sort" name="filter_sort" class="selectoption thin_select pt_8">
			        <? for ($i=0;$i<$personneltypesortdatacount;$i++): ?>
			        <option value="<?=$personneltypesortdata[$i]['value']?>" <?=$filter_sort==$personneltypesortdata[$i]['value']?"selected=selected":""?>><?=$personneltypesortdata[$i]['name']?></option>
			        <? endfor; ?>
			    </select>
...
<div class="table_title" align="center">
	<div align="left" class="px_16 float_left table_title_header">Personnel Type</div>
</div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="list">
	<tr style="background-color:#D7D7D7;" class="line_20">
		...
		<th width="1%" class="table_solid_bottom px_10 darkgray unselectable" align="center"></th>
		<th class="table_solid_top table_solid_bottom px_11 darkgray unselectable" align="center">Type Name</th>
