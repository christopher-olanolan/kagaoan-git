		...
		?>
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=add-computation" id="addForm">
        	...
        	<div style="width:100%;" align="left">
            	...
            	<div class="table_title" align="center">
            		<div align="left" class="px_16 float_left table_title_header">Shipment : Add Item</div>
				</div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	...
                	<tr>
                        ...
                        <td><input id="cases" name="cases" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                ...
                <div style="width:100%;" align="left">
	                ...
	                <input name="add" type="submit" value="Add Item" class="button" />
                </div>
            </div>
            </form>
