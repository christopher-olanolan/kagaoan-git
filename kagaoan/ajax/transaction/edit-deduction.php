		<?php
			$data = $connect->single_result_array("SELECT * FROM deduction WHERE id = '{$id}'");
			...
			$select_type =  $select->option_query(
				...
				$data['deduction_id'],			// default selected value
				'active = "1"',					// query condition(s)  
		...
		?>
        	...
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=edit-deduction" id="editForm">
        	...
        	<div style="width:100%;" align="left">
            	...
            	<div class="table_title" align="center">
            		<div align="left" class="px_16 float_left table_title_header">Edit Deduction</div>
				</div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                    ...
                    <tr id="tr_personnel_id" class="<?=$data['deduction_id'] == 3 ? '':'hidden'?>">
                    ...
                    <tr>
                        ...
                        <td><input id="date_from" name="date_from" type="text" class="inputtext default_inputtext datepicker" maxlength="50" value="<?=$data['date_from']?>" /></td>
                        <td><label for="date_from" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Date To: </td>
                        <td><input id="date_to" name="date_to" type="text" class="inputtext default_inputtext datepicker" maxlength="50" value="<?=$data['date_to']?>" /></td>
                ...
                <div style="width:100%;" align="left">
	                ...
	                <input name="update" type="submit" value="Update Deduction" class="button" />
                </div>
            </div>
            </form>
