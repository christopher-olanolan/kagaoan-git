		...
		?>
        	...
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=add-consumption" id="addForm">
        	<div style="width:100%;" align="left">
            	...
            	<div class="table_title" align="center">
            		<div align="left" class="px_16 float_left table_title_header">Add Diesel Comsumption</div>
				</div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                    ...
                    <tr>
                        ...
                        <td><input id="consumption_date" name="consumption_date" type="text" class="inputtext default_inputtext datepicker" maxlength="50" value="<?=date("Y-m-d")?>" /></td>
                        <td><label for="consumption_date" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Liters: </td>
                        <td><input id="liters" name="liters" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                ...
                <div style="width:100%;" align="left">
	                ...
	                <input name="update" type="submit" value="Add Consumption" class="button" />
                </div>
            </div>
            </form>
