		...
		?>
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=add-truck" id="addForm">
        	<div style="width:100%;" align="left">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	<tr>
                        ...
                        <td><input id="plate" name="plate" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td width="420"><label for="plate" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Truck Model: </td>
                        <td><input id="truck_model" name="truck_model" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td ><label for="truck_model" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Truck Type: </td>
                        <td><input id="truck_type" name="truck_type" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                ...
                <div style="width:100%;" align="left">
	                ...
	                <input name="update" type="submit" value="Add Truck" class="button" />
                </div>
            </div>
            </form>
            ...
            $(document).ready(function() {
            	$("#addForm").validate({
					rules: {
						plate : {
							required: true,
							remote: "<?=__ROOT__?>/index.php?file=ajax&ajax=<?=$ajax?>&control=plate" 
						},
						truck_tpe : {
							required: true
						},
