			<? $data = $connect->single_result_array("SELECT * FROM materials WHERE id = '{$id}'"); ?>
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=edit-materials" id="editForm">
        	...
        	<div style="width:100%;" align="left">
            	...
            	<div class="table_title" align="center">
            		<div align="left" class="px_16 float_left table_title_header">Materials : Edit Material</div>
				</div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	<tr>
                        ...
                        <td><input id="material" name="material" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['material']?>" /></td>
                        <td width="420"><label for="material" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Description: </td>
                        <td><input id="description" name="description" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['description']?>" /></td>
                        <td ><label for="description" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Gross Weight: </td>
                        <td><input id="gross_weight" name="gross_weight" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['gross_weight']?>" /></td>
                        <td ><label for="gross_weight" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Volume: </td>
                        <td><input id="volume" name="volume" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['volume']?>" /></td>
            	...
            	$("#editForm").validate({
					rules: {
						material : {
							required: true,
							isNumbers: true,
							remote: "<?=__ROOT__?>/index.php?file=ajax&ajax=<?=$ajax?>&control=get-unique-material&id=<?=$id?>" 
						},
						description : {
							required: true
						},
