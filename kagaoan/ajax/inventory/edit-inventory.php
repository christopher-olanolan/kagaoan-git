		<?php
			$data = $connect->single_result_array("SELECT * FROM inventory WHERE id = '{$id}'");
			...
			$select_brand =  $select->option_query(
				...
				$data['brand'],					// default selected value
		...
		?>
        	...
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=edit-inventory" id="editForm">
        	...
        	<div style="width:100%;" align="left">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	<tr>
                        ...
                        <td><input id="name" name="name" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['name']?>" /></td>
                        <td width="420"><label for="name" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15 line_30" valign="top">Description: </td>
                        <td><textarea id="description" name="description" class="textarea default_textarea"><?=$data['description']?></textarea></td>
                    ...
                    <tr>
                        ...
                        <td><input id="supplier" name="supplier" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['supplier']?>" /></td>
                        <td><label for="supplier" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Purchase Date: </td>
                        <td><input id="purchase_date" name="purchase_date" type="text" class="inputtext default_inputtext datepicker" maxlength="50" value="<?=$data['purchase_date']?>" /></td>
                        <td><label for="purchase_date" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Price: </td>
                        <td><input id="unit_price" name="unit_price" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['unit_price']?>" /></td>
                        <td><label for="unit_price" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Unit: <i class="pt_8">i.e. (kg, lbs)</i> </td>
                        <td><input id="unit" name="unit" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['unit']?>" /></td>
                        <td><label for="unit" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Stocks: </td>
                        <td><input id="stocks" name="stocks" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['stocks']?>" /></td>
                        <td><label for="stocks" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Stock Limit: </td>
                        <td><input id="stock_limit" name="stock_limit" type="text" class="inputtext default_inputtext" maxlength="50" value="<?=$data['stock_limit']?>" /></td>
