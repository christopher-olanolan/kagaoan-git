		...
		?>
        	...
        	<form method="post" enctype="multipart/form-data" action="<?=__ROOT__?>/index.php?file=action&action=add-personnel" id="addForm">
        	<div style="width:100%;" align="left">
            	...
            	<div class="table_title" align="center">
            		<div align="left" class="px_16 float_left table_title_header">Personnel : Add Personnel</div>
				</div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right">
                	<tr>
                        ...
                        <td><input id="empno" name="empno" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td width="420"><label for="empno" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Firstname: </td>
                        <td><input id="firstname" name="firstname" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td ><label for="firstname" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Lastname: </td>
                        <td><input id="lastname" name="lastname" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td><label for="lastname" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Middlename: </td>
                        <td><input id="middlename" name=""middlename"" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td><label for=""middlename"" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15 line_30" valign="top">Address: </td>
                        <td><textarea id="address" name="address" class="textarea default_textarea"></textarea></td>
                    ...
                    <tr>
                        ...
                        <td>
	                        <select id="gender" name="gender" class="selectoption default_select">
	                            ...
	                            <option value="<?=$genderdata[$i]['value']?>"><?=$genderdata[$i]['name']?></option>
	                            <? endfor; ?>
							</select>
						</td>
                    ...
                    <tr>
                        ...
                        <td><input id="hire" name="hire" type="text" class="inputtext default_inputtext datepicker" maxlength="50" value="" /></td>
            	...
            	<table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	<tr>
                        ...
                        <td><input id="mobile" name="mobile" type="text" class="inputtext default_inputtext isNumeric" maxlength="50" value="" /></td>
                        <td width="420"><label for="mobile" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">Landline: </td>
                        <td><input id="landline" name="landline" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
            	...
            	<table width="100%" border="0" cellpadding="0" cellspacing="5" class="table_solid_bottom table_solid_left table_solid_right radius_bottom_10">
                	<tr>
                        ...
                        <td><input id="sss" name="sss" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td width="420"><label for="sss" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">PAGIBIG: </td>
                        <td><input id="pagibig" name="pagibig" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                        <td><label for="pagibig" generated="false" class="error"></label></td>
                    </tr>
                    <tr>
                    	<td class="pad_left_15">TIN: </td>
                        <td><input id="tin" name="tin" type="text" class="inputtext default_inputtext" maxlength="50" value="" /></td>
                ...
                <div style="width:100%;" align="left">
	                ...
	                <input name="update" type="submit" value="Add Personnel" class="button" />
                </div>
            </div>
            </form>
            ...
            $(document).ready(function() {
            	$("#addForm").validate({
					rules: {
						empno : {
							required: true,
							remote: "<?=__ROOT__?>/index.php?file=ajax&ajax=<?=$ajax?>&control=empno" 
						},
						firstname : {
							required: true
						},
